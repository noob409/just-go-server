...
import { addPlaceCollection, createTrip, deleteTrip, favorTrip, popularTrips, searchTripById, deletePlaceCollection, placeToPlan, getCollection, getPlan, getDay, getAttraction, getTrip, createPlan } from "../../controllers/api/trip.controller.js";
...
// 刪除行程，意味著，所有與之相關的方案都要被刪除（need to delete tripLike, tripShare, plan, day, and attraction待修改）
TripRouter.delete("/:id", validateParams(['id']), deleteTrip);

TripRouter.get("/:id/getspecifictripinfo", validateParams(['id']), getTrip);  // Test OK
