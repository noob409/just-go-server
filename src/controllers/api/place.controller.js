    ...
    for (const placeId of googlePlaceIdList) {
      ...
      if (!place) {
        ...
        const result = await axios.get(
          `https://maps.googleapis.com/maps/api/place/details/json?fields=place_id%2Cname%2Cphoto%2Crating%2Cformatted_address%2Cformatted_phone_number%2Cwebsite%2Copening_hours&place_id=${placeId}&key=${process.env.GOOGLE_MAP_API_KEY}&language=zh-TW&region=TW`
        );
